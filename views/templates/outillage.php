<div class="page-header header-bg-outillage">
    <div class="header-content">
        ...
        <div class="breadcrumb">
            <a href="index.php?action=home">Accueil</a> > <span>Outillage</span>
        </div>
    </div>
</div>
                ...
                <div class="category-filters">
                    <?php foreach ($filterOptions as $type): ?>
                        <div class="checkbox-group">
                            <input type="checkbox" id="type-<?= $type ?>" name="tool_type" value="<?= $type ?>" onchange="this.form.submit()" <?= ($currentFilter === $type) ? 'checked' : '' ?>>
